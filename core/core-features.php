...
class plugin_features_sinapicv2{
	/**
	 * get_filemtime
	 * 
	 ...
	 */
	static function get_filemtime($file_name = null,$format = 'YmdHis'){
	 ...
	 * @author KM@INN STUDIO
	 */
	static function get_plugin_file_path($file_name = null){
	 ...
	 * @author KM@INN STUDIO
	 */
	static function get_plugin_file_url($file_name = null,$mtime = true){
	 ...
	 * @author KM@INN STUDIO
	 */
	static function get_plugin_js($file_name = null,$url_only = true,$mtime = true){
	 ...
	 * @author KM@INN STUDIO
	 */
	static function get_plugin_css($file_name = null,$param = null,$mtime = true){
